...
template <>
const std::string c2py::tp_ctor_doc<app4triqs::toto> = init_0.doc(R"DOC(
...
template <>
const std::string c2py::tp_doc<app4triqs::toto> = R"DOC(A very useful and important class

.. note::

   A Useful note)DOC"
   + std::string{"\n\n----------\n\n"} + c2py::tp_ctor_doc<app4triqs::toto>;
