...
# c++2py ../../c++/app4triqs/solver_core.hpp -p --members_read_only -N app4triqs -a app4triqs -m solver_core -o solver_core --moduledoc="The app4triqs solve_core module" -C triqs --cxxflags="-std=c++17" --target_file_only
